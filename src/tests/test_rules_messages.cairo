...
use super::mocks::messages::MessagesContract;

use messages::messages::MessagesComponent::InternalTrait as MessagesInternalTrait;
...
fn setup() -> MessagesContract::ContractState {
  ...
  MessagesContract::contract_state_for_testing()
}
...
fn test__is_message_signature_valid_voucher() {
  ...
  assert(
    state.messages._is_message_signature_valid(:hash, :signature, signer: voucher_signer),
...
fn test__is_message_signature_valid_order() {
  ...
  assert(
    state.messages._is_message_signature_valid(:hash, :signature, signer: order_signer),
...
fn test_message_consumption() {
  ...
  assert(!state.messages._is_message_consumed(:hash), 'Should not be consumed');

  state.messages._consume_message(:hash);
